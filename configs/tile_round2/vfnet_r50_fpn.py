...
train_cfg = dict(
    assigner=dict(type='ATSSAssigner', topk=9, gpu_assign_thr=10),
    allowed_border=-1,
    pos_weight=-1,
    debug=False)
test_cfg = dict(
...
data_root = 'data/data_guangdong/tile_round2_train_20210204/'
img_norm_cfg = dict(
...
load_from = None
resume_from = None
work_dir = 'work_dirs/round2/vfnet_r50_base'
workflow = [('train', 1)]
