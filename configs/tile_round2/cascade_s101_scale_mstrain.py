...
train_pipeline = [
    ...
    dict(
        type='Concat',
        template_folder_path='data/data_guangdong/tile_round2/template_aligned'
    ),
    dict(
        type='Resize',
    ...
    dict(
        ...
        transforms=[
            dict(
                ...
                'data/data_guangdong/tile_round2/template_aligned'),
...
load_from = None
resume_from = None
work_dir = 'work_dirs/round2/cascade_s101_scale_mstrain_fpn_tunerpn'
workflow = [('train', 1)]
