...
train_pipeline = [
    ...
    dict(type='OnlineFusion', defect_folder=data_root + 'defects'),
    dict(
        type='Resize',
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file=data_root + 'infos/train_temp.pkl',
        img_prefix=data_root + 'train_imgs_all/',
...
log_level = 'INFO'
load_from = None
resume_from = 'work_dirs/round2/cascade_s101_online_fusion_mstrain_pafpn/latest.pth'
work_dir = 'work_dirs/round2/cascade_s101_online_fusion_mstrain_pafpn'
workflow = [('train', 1)]
