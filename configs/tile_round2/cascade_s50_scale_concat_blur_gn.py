...
log_level = 'INFO'
load_from = None
resume_from = 'work_dirs/round2/cascade_s50_base_scale_concat_blur_gn/latest.pth'
work_dir = 'work_dirs/round2/cascade_s50_base_scale_concat_blur_gn'
workflow = [('train', 1)]
