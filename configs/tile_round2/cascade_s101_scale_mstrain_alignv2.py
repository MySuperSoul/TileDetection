...
model = dict(
    ...
    train_with_tmp=True,
    method='scale_sub_feat',
    scale_origin_ratio=1.0,
...
train_pipeline = [
    ...
    dict(
        type='Concat',
        template_folder_path='data/data_guangdong/tile_round2/template_aligned_v2'
    ),
    dict(
        type='Resize',
        img_scale=[(1400, 1400), (1500, 1500), (1600, 1600)],
    ...
    dict(
        ...
        transforms=[
            dict(
                ...
                'data/data_guangdong/tile_round2/template_aligned_v2'),
...
log_level = 'INFO'
load_from = None
resume_from = 'work_dirs/round2/cascade_s101_scale_mstrain_alignv2/latest.pth'
work_dir = 'work_dirs/round2/cascade_s101_scale_mstrain_alignv2'
workflow = [('train', 1)]
