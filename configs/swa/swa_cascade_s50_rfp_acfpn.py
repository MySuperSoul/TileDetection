_base_ = ['../tile_round2/cascade_s50_rfpac_mstrain.py', '../_base_/swa.py']
...
swa_load_from = '/work/work_dirs/round2/cascade_s50_rfp_mstrain_aug_alldata_acfpn/latest.pth'
...
work_dir = '/work/work_dirs/round2/swa_cascade_s50_rfp_mstrain_acfpn'