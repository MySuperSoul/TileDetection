...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file=data_root + 'infos/train_infos_sliding.pkl',
        img_prefix=data_root + 'sliding_crop_images/',
        pipeline=train_pipeline),
    val=dict(
        type=dataset_type,
        ann_file=data_root + 'infos/val_infos_sliding.pkl',
        img_prefix=data_root + 'sliding_crop_images/',
...
log_level = 'INFO'
load_from = None
resume_from = 'work_dirs/sliding_crop_r50_baseline/epoch_12.pth'
work_dir = 'work_dirs/sliding_crop_r50_baseline'
workflow = [('train', 1)]
