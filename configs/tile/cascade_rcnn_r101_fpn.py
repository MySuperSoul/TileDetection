...
train_pipeline = [
    ...
    dict(type='Resize', img_scale=(1843, 1350), keep_ratio=True),
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file=data_root + 'train_infos.pkl',
        img_prefix=data_root + 'train_imgs/',
        pipeline=train_pipeline),
    val=dict(
        type=dataset_type,
        ann_file=data_root + 'val_infos.pkl',
        img_prefix=data_root + 'train_imgs/',
...
load_from = None
resume_from = None
work_dir = 'work_dirs/r101_baseline'
workflow = [('train', 1)]
