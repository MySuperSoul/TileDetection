...
data_root = 'data/data_guangdong/tile_round1_train_20201231/'
img_norm_cfg = dict(
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file=data_root + 'infos/train_all_positive_canny_win1650.pkl',
        img_prefix=data_root + 'croped_slide_train_win1650/',
        pipeline=train_pipeline),
    val=dict(
        type=dataset_type,
        ann_file=data_root + 'infos/val_canny_win1650.pkl',
        img_prefix=data_root + 'croped_slide_train_win1650/',
...
load_from = None
resume_from = None
work_dir = 'work_dirs/faster_r50_baseline_v2'
workflow = [('train', 1)]
